...
function extractFields(nalType, data) {
    ...
    if (nalType === 32) {
        ...
        fields.push({ name: "vps_max_dpb_size", value: (data[9] >> 4) & 0x0F });
        ...
        fields.push({ name: "vps_max_dec_pic_buffering_minus1", value: (data[12] + (data[13] << 8)) >> 1 }); // Add the missing field
    } else if (nalType === 33) {
