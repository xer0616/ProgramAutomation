...
function extractFields(nalUnitType, payloadData) {
    ...
    try {
        if (nalUnitType === 32) { // VPS_NUT (Video Parameter Set, Section 7.3.2.1)
            ...
            // --- sps_sample_adaptive_offset_enabled_flag: u(1) --- [ADDED]
    ...
    if (fields.length === 0) {
        ...
        fields.forEach((field, fieldIndex) => {
            ...
            const isPotentiallyEditable =
                ...
                field.name !== 'sps_max_dec_pic_buffering_minus1[i]' && // Explicitly disable (ue(v) in loop)
                ...
                field.name !== 'sps_sample_adaptive_offset_enabled_flag' && // [ADDED] Explicitly disable (after amp_flag)
...
//          IT CANNOT MODIFY Exp-Golomb fields or fields after them (e.g. pic_width/height, ..., max_transform_hierarchy_depth_inter, max_transform_hierarchy_depth_intra, scaling_list_enabled_flag, sps_amp_enabled_flag, sps_sample_adaptive_offset_enabled_flag).
    ...
    inputsToApply.forEach(input => {
         ...
         try {
             ...
             // --- SPS Fields (Type 33) --- Applicable only if nalType is 33
                 ...
                 // sps_sample_adaptive_offset_enabled_flag, etc.)
                 ...
                 // The input fields for these should be disabled by displayFields.
                      ...
                      // [MODIFIED] Added sps_sample_adaptive_offset_enabled_flag to the check
                      if (fieldName === 'pic_width_in_luma_samples' ||
                          ...
                          fieldName === 'sps_max_dec_pic_buffering_minus1[i]' ||
                          ...
                          fieldName === 'sps_sample_adaptive_offset_enabled_flag' || // [ADDED]
