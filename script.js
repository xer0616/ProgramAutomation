...
function extractFields(nalUnitType, payloadData) {
    ...
    try {
        if (nalUnitType === 32) { // VPS_NUT (Video Parameter Set, Section 7.3.2.1)
            ...
            // [ADDED] Added the missing pcm_sample_bit_depth_chroma_minus1 field
...
function displayFields(nalName, fields, nalUnitType, layerId, temporalId, nalIndex) { // Added nalIndex
    ...
    if (fields.length === 0) {
        ...
        fields.forEach((field, fieldIndex) => {
            ...
            // [MODIFIED] Added pcm_sample_bit_depth_chroma_minus1 to the disable list
...
function modifyStream() {
    // ** IMPORTANT WARNING **
    // [MODIFIED] Updated warning to include pcm_sample_bit_depth_chroma_minus1
         ...
         try {
             ...
             // --- SPS Fields (Type 33) --- Applicable only if nalType is 33
                 ...
                 // The input fields for these should be disabled by displayFields.
                      ...
                      // [MODIFIED] Added pcm_sample_bit_depth_chroma_minus1 to the check
